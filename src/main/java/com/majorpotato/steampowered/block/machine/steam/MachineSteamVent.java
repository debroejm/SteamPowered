...
import com.majorpotato.steampowered.tileentity.machine.steam.TEntitySteamVent;
...
public class MachineSteamVent extends MachineSteam {
    public MachineSteamVent()
    {
        super();
        this.setBlockName("machineSteamVent");
    ...
    public void onBlockPlacedBy(World world, int i, int j, int k, EntityLivingBase entityliving, ItemStack itemStack)
    {
        ...
        if(ent instanceof TEntitySteamVent) ((TEntitySteamVent)ent).rotateBlock(Direction.fromID(facing));
    }
