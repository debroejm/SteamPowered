...
import com.majorpotato.steampowered.tileentity.machine.mechanical.TEntityChain;
import net.minecraft.tileentity.TileEntity;
import net.minecraft.world.World;

public class MachineChain extends MachineMechanical {
    public MachineChain()
    {
        super();
        this.setBlockName("machineChain");
